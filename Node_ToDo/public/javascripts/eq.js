console.log("===============================");
console.log("JS에서 eq비교 연산자");
/*
JS 에서 같은 값을 비교할 때 사용하는 연산자가 2가지가 있다.
    동등연산자 : ==
    평등연산자 : ===
*/
...
// 문자열 "1"을 숫자형으로 또는 숫자 1을 문자열형 "1"로 자동 형변환을 하여 비교해버린다.
// 어떤 값을 DB등에서 읽어왔을때 순수하게 내용으로만 비교하고자 할 때는 필요
